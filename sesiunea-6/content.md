            ...
            int main() {
                ...
                for(int i = 0; i < strlen(cuvant); i++) {
                    if(pozitieVocala == -1 && esteVocala(cuvant[i])) {
                        pozitieVocala = i;
                    } else if (esteConsoana(cuvant[i])) {https://www.familio.ro/umerase-haine-lemn-artar-20-bucati-natur?gad_source=1&gclid=Cj0KCQiAjMKqBhCgARIsAPDgWlz8mQ1KZ7azHilWJsPPFgHViBYcacsy1cX7vLPAbJyiuNZmnK8VUtYaAp5vEALw_wcB
                }
    ...
    - Solutie:
        ```c++
            ...
            int main() {
                ...
                int indexCopie = 0;
                for (int i = 0; i < strlen(text); i++) {            #include <string.h>
            #include <cctype>
